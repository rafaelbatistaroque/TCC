...
namespace Colaborador.Infra.EF.Migrations
{
    ...
    [Migration("20210522200804_alterando_campos_migration_colaborador")]
    partial class alterando_campos_migration_colaborador
    {
                    ...
                    b.OwnsOne("Colaborador.Domain.ValueObjects.ColaboradorFuncao", "Funcao", b1 =>
                        {
                            ...
                            b1.Property<string>("FuncaoNome")
                                .HasMaxLength(30)
                                .HasColumnType("varchar(30)")
                                .HasColumnName("FuncaoNome");
